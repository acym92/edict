...
```bash
curl http://0.0.0.0:7891/api/remote-skills-list | jq .
...
**请求：**
```bash
curl -X POST http://0.0.0.0:7891/api/add-remote-skill \
...
```bash
curl http://0.0.0.0:7891/api/remote-skills-list
```
...
```bash
curl -X POST http://0.0.0.0:7891/api/update-remote-skill \
  -H "Content-Type: application/json" \
  -d '{
    "agentId": "zhongshu",
    "skillName": "code_review"
...
```bash
curl -X POST http://0.0.0.0:7891/api/remove-remote-skill \
  -H "Content-Type: application/json" \
  -d '{
    "agentId": "zhongshu",
    "skillName": "code_review"
