...
ID_LABEL = {
    ...
    'hanlinyuan': {'label': '翰林院', 'role': '翰林学士', 'duty': '论文任务主流程',      'emoji': '📚'},
    'dalisi':   {'label': '大理寺', 'role': '大理寺卿', 'duty': '论文审查与把关',       'emoji': '🏛️'},
...
def main():
    ...
    EXTRA_AGENTS = {
        ...
        'zhongshu': {'model': default_model, 'workspace': str(pathlib.Path.home() / '.openclaw/workspace-zhongshu'),
                    'allowAgents': ['menxia', 'shangshu']},
        'menxia': {'model': default_model, 'workspace': str(pathlib.Path.home() / '.openclaw/workspace-menxia'),
                    'allowAgents': ['zhongshu', 'shangshu']},
        'main':    {'model': default_model, 'workspace': str(pathlib.Path.home() / '.openclaw/workspace-main'),
                    'allowAgents': ['zhongshu','menxia','hanlinyuan','dalisi']},
